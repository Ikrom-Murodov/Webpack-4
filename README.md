...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ts-watch    | (yarn run ts-watch) TS начинаеть 'слидить' за файлами с рисширением .ts, в директории src/ts и при изменении этих файлов начнет компилировать файл .ts в .js в директории src/js |
